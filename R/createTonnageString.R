...
createTonnageString <- function(itemName, chosenItem) {
  if (is.numeric(chosenItem)) {
    ...
    if (tolower(chosenItem) == "all") {
      ...
      stop(
        "Not valid tonnage Argument. Either \"ALL\" or a vector of tonnage classes (see toncl1)"
      )
    }
